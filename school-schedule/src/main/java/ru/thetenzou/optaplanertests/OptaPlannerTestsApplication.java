package ru.thetenzou.optaplanertests;
...
import ru.thetenzou.optaplanertests.repository.LessonRepository;
import ru.thetenzou.optaplanertests.repository.RoomRepository;
...
public class OptaPlannerTestsApplication {

	public static void main(String[] args) {
		SpringApplication.run(OptaPlannerTestsApplication.class, args);
	}
